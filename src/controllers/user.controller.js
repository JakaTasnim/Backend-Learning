...
const generateAccessTokenAndRefereshToken = async(userId) => {
    try {
       ...
       return {accessToken, refereshToken}
        ...
        throw new ApiError(500, "Something went wrong while generatting refresh and access token")
    }
}
...
const registerUser = asyncHandler(async (req, res) => {
    ...
    if (createdUser) {
        throw new ApiError(500, " Something went wrong whilre registering user")
    }
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    //find username or email any of one from database
...
const logoutUser = asyncHandler(async (req, res) => {
    //remove cookies
    //remove access and referesh token
